...
body(
    ...
    "Reinforcement Learning, and 6G network systems. PhD expected Summer 2026. "
    ...
    "publish original research, teach at the university level, and deliver "
    "production-grade ML pipelines. Innovation, teamwork, leadership, and "
    "results-oriented.",
    space_after=3,
)
...
skills = [
    ...
    ("LLM / Agents",
     "LangChain, LangGraph, LangSmith, MCP, RAG, Claude (Haiku, Opus), KIRO"),
    ("AI / ML",
     "TensorFlow, PyTorch, Scikit-Learn, MARL (QMIX, QTRAN), GNN, DQN, "
     "NLP, Computer Vision, LLMs"),
    ("Data",
     "PySpark, Databricks, Snowflake, Delta Lake, Relational Databases, "
     "ETL/ELT"),
    ("Cloud",
     "AWS (SageMaker, Bedrock AgentCore, CloudWatch), OpenStack, "
     "Kubernetes, Docker"),
    ("DevOps", "Jenkins, CI/CD, Git, GitHub Actions, GitLab"),
    ("Web / Mobile",
     "React, Angular, Node.js, D3.js, Plotly, Dash, Power BI, Tableau, "
     "Mobile Dev."),
    ("Methods",
     "Agile/Scrum, TDD, Design Patterns, Statistical Modeling, Big Data, "
     "Data Visualization"),
]
...
experiences = [
    ...
    ("Contractual Statistical Economist Engineer",
     ...
     ["Analyze data to support policy decisions."]),
...
internships = [
    ("Machine Learning Intern", "Ericsson, Montréal", "2026", [
        "Build an LLM model and a RAG Agentic AI Agent.",
        "Develop data pipelines and ML models; research and implement ML "
        "algorithms.",
        "Test and optimize data & ML pipelines.",
        "Collaborate with teams for maintainable, scalable code.",
        "Ensure quality via unit/integration tests; continuous analysis and "
        "requirement handling.",
        "Deploy on AWS SageMaker; monitor pipelines.",
        "Stack: Python, AWS, SQL, GitLab, KIRO, LangChain, LangGraph, "
        "LangSmith, SageMaker, Bedrock AgentCore, MCP, Claude, CI/CD, "
        "CloudWatch.",
    ]),
