...
%%
\section{Retombées et contributions sur tous les plans}\label{sec:concl-retombees}
...
%%  TRANSFERABILITE
%%
\section{Transférabilité à d'autres domaines}\label{sec:concl-transferabilite}
...
%%
\section{Implications institutionnelles et réglementaires}\label{sec:concl-institutions}
...
%%
\section{Bilan quantitatif global}\label{sec:concl-bilan}
...
\midrule
PDR (taux de livraison) & QMIX & 85--92\% & $\geq$ 98\% & +6--13 pts \\
...
Détection politiques voyous & Shield binaire & 60--70\% & 74.2--98.3\% & +14--28 pts \\
Faux positifs & CPO & 2--8\% & \textbf{0\%} & Élimination totale \\
Latence par décision & CPO & $\sim$15\,ms & 3.07\,ms & 4.9$\times$ $\downarrow$ \\
Critères couverts (/12) & Meilleur concurrent & 4 & \textbf{12} & 3$\times$ $\uparrow$ \\
