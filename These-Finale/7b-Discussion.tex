...
Un résultat non anticipé d'OS2 est la révélation que le carbone incorporé domine d'environ six ordres de grandeur le carbone opérationnel --- un écart qui remet en question les priorités de la communauté des réseaux verts et dépasse les engagements initiaux d'OS2 (voir Section~\ref{sec:disc-transversale}).
