...
\begin{table}[htbp]
\centering
\caption{Positionnement de la pile proposée par rapport aux principales approches de la littérature. Les paramètres des approches de référence sont tirés de~\cite{heinzelman2000leach,rashid2018qmix,son2019qtran,achiam2017cpo,alshiekh2018shielding}; les métriques PDR et durée de vie sont issues de nos propres simulations (Section~\ref{sec:Demarche}).}
