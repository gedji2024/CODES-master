...
\begin{itemize}
    ...
    \item \textbf{Intensité carbone variable}~: \hl{l'intensité carbone du réseau électrique varie considérablement (de $\sim$50 à $\sim$500\,gCO$_2$/kWh selon le mix énergétique, l'heure et la saison)}~\cite{ember2024,uk_carbon_api}\hl{,} offrant une opportunité de modulation temporelle de la consommation.
\end{itemize}
