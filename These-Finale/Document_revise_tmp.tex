...
\include{6-Revue_litterature_REVISED}  % [RÉVISÉ — C2b] Section métaheuristiques enrichie, formule Heinzelman en display.
\include{6b-Demarche}          % Démarche de l'ensemble du travail de recherche (chapitre de transition)
...
\include{7b-Discussion}        % Discussion Générale (chapitre de discussion transversale)
\include{8-Conclusion_REVISED}  % [RÉVISÉ — C6/C8] Titres de sections révisés, recommandations renforcées.
%\backmatter
\ifthenelse{\equal{\Langue}{english}}{
