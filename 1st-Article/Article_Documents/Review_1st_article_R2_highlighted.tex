...
\usepackage{soul} 
\sethlcolor{yellow}
% --- Revision highlighting environment for Round 2 changes ---
\newtcolorbox{revision}{colback=yellow!15, colframe=yellow!60!black, 
  breakable, boxrule=0.5pt, left=4pt, right=4pt, top=2pt, bottom=2pt,
  title={\small\sffamily\bfseries Round~2 Addition}}
...
\begin{enumerate}
    ...
    \item \textbf{Static topology assumption.} GAPF computes the graph embedding once per episode and selects a fixed expert for the entire episode. In scenarios with mobile sensors or rapidly changing channel conditions, step-level re-evaluation may be necessary.
...
He received a bachelor's degree in software engineering from Polytechnique Montréal in $2021$. \hl{He holds a Master's degree in Statistics from the University of Yaoundé I. He also holds another Master's degree in Mathematics from the same university.}
\end{IEEEbiography}
